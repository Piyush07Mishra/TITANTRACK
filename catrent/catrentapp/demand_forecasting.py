...
def equipment_demand_forecast(df, output_folder='forecast/', train_year_cutoff=2024, test_year=2025):
    ...
    # Preserve original equipment type for reliable post-prediction reporting
    complete_df["equipment_type_original"] = complete_df["equipment_type"]
    ...
    feature_cols = [col for col in train_df.columns if col not in 
                    ["year_week", "target_checkout_count", "is_train", "is_test", "equipment_type_original"]]
    ...
    # Use preserved equipment type (more reliable than reconstructing from one-hot columns)
    test_df["equipment_type"] = test_df["equipment_type_original"]
